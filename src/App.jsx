...
const comedians = [
  { id: 1, name: "Zakir Khan", style: "Self-deprecating", bio: "The OG sakht launda of Indian comedy." },
  { id: 2, name: "Kanan Gill", style: "Self-deprecating", bio: "The king of thoughtprovoking comedy in India." },
  { id: 3, name: "Vir Das", style: "Political", bio: "The global face of Indian comedy." },
  { id: 4, name: "Kenny Sebastian", style: "Observational", bio: "The master of everyday comedy." },
  { id: 5, name: "Biswa Kalyan Rath", style: "Dark Humour", bio: "The dark knight of Indian comedy." }, 
  {id: 6, name: "Abish Mathew", style: "Observational", bio: "The singing sensation of Indian comedy." },
]
